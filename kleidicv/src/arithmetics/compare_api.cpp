...
#define KLEIDICV_DEFINE_CMP_EQ_API(name, type)                       \
  KLEIDICV_MULTIVERSION_C_API_WITH_SME(                              \
      name,                                                          \
      KLEIDICV_SCALAR_OR_NEON(&kleidicv::sc::compare_equal<type>,    \
                              &kleidicv::neon::compare_equal<type>), \
...
#define KLEIDICV_DEFINE_CMP_GT_API(name, type)                         \
  KLEIDICV_MULTIVERSION_C_API_WITH_SME(                                \
      name,                                                            \
      KLEIDICV_SCALAR_OR_NEON(&kleidicv::sc::compare_greater<type>,    \
                              &kleidicv::neon::compare_greater<type>), \
