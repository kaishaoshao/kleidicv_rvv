...
#define KLEIDICV_DEFINE_MINMAX_API(name, type)                 \
  KLEIDICV_MULTIVERSION_C_API_WITH_SME(                        \
      name,                                                    \
      KLEIDICV_SCALAR_OR_NEON(&kleidicv::sc::min_max<type>,    \
                              &kleidicv::neon::min_max<type>), \
...
#define KLEIDICV_DEFINE_MINMAXLOC_API(name, type)                  \
  KLEIDICV_MULTIVERSION_C_API_WITHOUT_SME(                         \
      name,                                                        \
      KLEIDICV_SCALAR_OR_NEON(&kleidicv::sc::min_max_loc<type>,    \
                              &kleidicv::neon::min_max_loc<type>), \
      nullptr)
